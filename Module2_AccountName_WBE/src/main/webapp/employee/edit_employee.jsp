...
<hr>
<form action="/furama?action=editEmployee&id=${employee.id}&userName=${employee.user}" method="post">
    <table>
        <tr>
            <td>Name:</td>
        ...
        <tr>
            <td>Birthday:</td>
            <td><input type="date" name="dob" value="${employee.birthday}"></td>
        </tr>
        <tr>
            <td>ID card:</td>
        ...
        <tr>
            <td>Address:</td>
            <td><input type="text" name="address" value="${employee.email}"></td>
        </tr>
        <tr>
            <td>Email:</td>
            <td><input type="text" name="email" value="${employee.address}"></td>
        </tr>
        <tr>
            <td>Position:</td>
            <td>
